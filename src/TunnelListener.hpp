...
class TunnelListener : public Server::Listener::ICallback, public TunnelClient::ICallback
{
public:
    TunnelListener(Server &server, const String &destinationHost, uint16 destinationPort) : _server(server), _destinationHost(destinationHost), _destinationPort(destinationPort) {}
